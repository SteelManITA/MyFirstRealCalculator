...
int main(int argc, char** argv)
{
    ...
    const parsersStruct* MfrcStruct = setupLang(grammar, grammarElements, sizeof(grammarElements) / sizeof(char*));
    ...
    mpc_cleanup(MfrcStruct->length, MfrcStruct->list[0], MfrcStruct->list[1], MfrcStruct->list[2], MfrcStruct->list[3],
                MfrcStruct->list[4]);
